...
const MenuItem = forwardRef<HTMLDivElement, MenuItemProps>(
  (
    ...
    const itemClassName = cn(
      ...
      `relative z-10 flex h-10 items-center gap-1.5 ${shape.item} px-3 text-sm font-medium cursor-pointer outline-none transition-[color,background-color,opacity] duration-150`,
    ...
    const content = (
      <>
        {Icon && (
          <span className="inline-grid">
            ...
            <Icon
              ...
              className={cn(
                "col-start-1 row-start-1 transition-[color,stroke-width,opacity] duration-150",
                isActive || checked
                  ? "text-foreground"
        ...
        <span className="inline-grid flex-1 text-sm pl-1.5">
          <span
          ...
          <span
            className={cn(
              "col-start-1 row-start-1 transition-[color,font-variation-settings,opacity] duration-150 [text-box:trim-both_cap_alphabetic]",
              isActive || checked
                ? "text-foreground"
                : "text-muted-foreground"
            )}
